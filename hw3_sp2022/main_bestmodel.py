...
class BestModel(torch.nn.Module):
    def __init__(self, n1_channels, n1_kernel, n2_channels, n2_kernel, pool1,
        ...
        self.conv = torch.nn.Sequential(
          torch.nn.Conv2d(1, n1_channels, n1_kernel),
          torch.nn.ReLU(),
          torch.nn.Conv2d(n1_channels, n2_channels, n2_kernel),
          torch.nn.ReLU(),
          torch.nn.AvgPool2d(pool1),
          torch.nn.Conv2d(n2_channels, n3_channels, n3_kernel),
          torch.nn.ReLU(),
          torch.nn.Conv2d(n3_channels, n4_channels, n4_kernel),
          torch.nn.ReLU(),
          torch.nn.AvgPool2d(pool2, stride=(2,2))
        )
        ...
        self.linear2 = torch.nn.Linear(linear_features, 6)
